...
// ReasoningEffort is the Codex reasoning effort value ("low", "medium",
// "high", or "xhigh"). The empty value leaves the Codex default in place.
type ReasoningEffort string

// Config configures the Codex driver.
//
// CommonConfig controls process, profile, and workspace defaults. Model,
// ReasoningEffort, and FastMode select Codex model and service-tier settings.
type Config struct {
	CommonConfig
...
// result to adaptor.New. Config validation stays
