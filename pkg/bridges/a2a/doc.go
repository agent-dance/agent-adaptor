// Package a2a exposes an agentadaptor.Runner as an A2A-compatible agent.
//
// Scope:
...
//   - maps SendMessage and SendStreamingMessage onto Runner.Start
//   - maps StreamEvents, Wait, and Cancel onto Task status/artifact updates
//
// The bridge is intentionally adapter-agnostic: it depends only on the core
// Runner / RunHandle contracts and never imports concrete adapters. It uses
