...
var (
	...
	_ adaptor.SharedOption = adaptor.WithAppendSystemPrompt("append")
	_ adaptor.Option       = adaptor.WithAppendSystemPrompt("append")
	_ adaptor.CallOption   = adaptor.WithAppendSystemPrompt("append")
