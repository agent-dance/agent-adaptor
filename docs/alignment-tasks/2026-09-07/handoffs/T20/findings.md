...
- Failed-handshake launch counts distinguish a delivered turn from empty prewarm. A Claude child dying before reading does not prove the parent's pipe write failed; no unsafe replay is the required observable outcome.
