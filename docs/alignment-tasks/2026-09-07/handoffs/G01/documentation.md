...
root AST 增量仅 RunError.Cause 和两种 Reason；SPI AST 增量仅三字段 StructuredOutputHITLCapability 与两个指针字段。没有旧 SDK/Start、模式选择器或根 With* 新入口。C01/C04 正文及 frozen hashes/ownership 同步 R003–R007，保留历史 G00 证据。
