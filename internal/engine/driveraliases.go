...
// This file mirrors the driver SPI aliases used by the historical root
// package so pipeline code moved from the root package compiles unchanged
// inside internal/engine. It is a verbatim (package-renamed) copy of the
// root driver_aliases.go surface.
