...
// [agentadaptor.CursorConfig], so struct literals remain interchangeable with
// the legacy cursor.New entry point; P5 flips the alias direction so this
// package owns the concrete type (docs/api-v1-implementation-plan.md P3.1).
type Config = agentadaptor.CursorConfig
