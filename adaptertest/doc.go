// Package adaptertest is the conformance suite for the driver SPI. It verifies
// implementations of [driver.Driver] directly and has no dependency on the
// root package's consumer API.
//
