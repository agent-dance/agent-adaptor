...
var (
	...
	_ driver.SessionConfigFingerprinter = referenceDriver{}
...
func (d referenceDriver) Run(ctx context.Context, req driver.Request, sink driver.EventSink) (driver.Response, error) {
	...
	if req.ModelOverride != "" {
		// Request.ModelOverride supersedes the configured model.
	...
	return driver.Response{
		// RSP-03: Output is final assistant-facing text only.
		Output: output,
...
func (d referenceDriver) SessionConfigFingerprint() (string, error) {
	return driver.CanonicalSessionConfigFingerprint("adaptertest/reference/v1;codec/reference/v1", d.cfg)
}
